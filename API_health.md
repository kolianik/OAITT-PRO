...
Returns the real-time operational status of the gateway, connection state to PostgreSQL 18, currently hot model in VRAM, and online statuses of the downstream inference services.
...
*   **`database_connected`** (*boolean*): Connection status to PostgreSQL 18.
